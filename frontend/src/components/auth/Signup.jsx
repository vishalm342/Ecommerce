...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ Optional: Redirect to login or dashboard after signup
      navigate("/login");
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-2 flex items-center">
                ...
                <label
                  htmlFor="file-input"
                  className="ml-5 flex items-center px-4 py-2 border border-gray-300 rounded-md text-sm text-gray-700 bg-white hover:bg-gray-50"
                >
                  <span>Upload</span>
                  <input
                    type="file"
